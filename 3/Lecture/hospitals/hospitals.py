...
class Space():
    ...
    def hill_climb(self, maximum=None, image_prefix=None, log=False):
        ...
        for i in range(self.num_hospitals):
            #--Add hospital at randomly available space:
        ...
        if image_prefix:
            ...
            #--KEY IDEA: keep hill-running until...
        ...
        while maximum is None or count < maximum:
            ...
            # Move to a highest-valued neighbor
                ...
                #--Move to one of the best hospitals (randomly, all equally best):
...
for i in range(15):
    #--Randomly generate 15 houses
    s.add_house(random.randrange(s.height), random.randrange(s.width))


# Use local search (hill-climbing) to determine hospital placement for 15 houses
hospitals = s.hill_climb(image_prefix="hospitals", log=True)
#
#
#
#--Use random restart to run multiple trials to find best hospitals placement:
#hospitals = s.random_restart(20, image_prefix="hospitals", log=True)

# Hill-climbing / random_restart will always move to a BETTER position than
# the current one, because sometimes we'll get stuck in a local maximum or
# local minimum... see: Simulated Annealing.

""" Remove all images with ext '.png' in current directory:
$ rm *.png
"""
