...
def shortest_path(source, target):
    ...
    """
    • Return a LIST, where each list item is the next (movie_id, person_id) pair in the path from source to target. Each pair should be a tuple of 2 INTs.
    • Return None if no possible connection.
    • If multiple possible shortest paths, return any of them.
    """
